        ...
        <div className="flex h-16 items-center justify-between">
          <Link href="/" className={`flex items-center gap-2.5 ${s.text}`}>
            ...
            <span className={`text-lg tracking-tight ${isSerif ? "font-serif font-semibold" : "font-semibold"}`}>
              Bio <span className={s.logo}>Peptides</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-7">
            ...
            <CartIcon />
            <a
              href="https://wa.me/447000000000?text=Hi%20Bio%20Peptides%2C%20I%27d%20like%20to%20place%20an%20order.%20Can%20you%20help%3F"
              target="_blank"
          ...
          <button
            type="button"
            className={`md:hidden p-2 ${s.text}`}
