...
export const metadata: Metadata = {
  title: "Contact Bio Peptides | UK Research Peptide Supplier",
  description:
    "Contact Bio Peptides — the UK's fastest research peptide supplier. Same-day dispatch by 2pm. Get in touch for order support, technical queries, and CoA requests.",
};
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Email research@biopeptides.co.uk with your order reference number and a brief description of the issue. If it's related to same-day dispatch, get in touch before 1:30pm — that gives us time to sort it before the 2pm cut-off.",
  },
  {
    question: "Can you help with technical questions about peptide specs or CoAs?",
    answer:
      "Yes. Our team can advise on purity grades, sequence confirmation, and CoA documentation. All Bio Peptides products come with third-party CoAs as standard. Include the product name or code and what you need when you get in touch.",
  },
];
      ...
      <section className="pt-24 pb-16 lg:pt-32 lg:pb-20 bg-editorial-surface">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-editorial-text leading-[1.15]">
            Contact Bio Peptides — UK Research Peptide Supplier
          </h1>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="mt-8 rounded-xl border border-editorial-border bg-editorial-surface p-5">
                ...
                <p className="text-sm text-editorial-muted leading-relaxed">
                  ...
                  <a href="mailto:research@biopeptides.co.uk" className="text-editorial-accent hover:text-editorial-accent-dark transition-colors">
              ...
              <div className="mt-6">
                ...
                <p className="text-sm text-editorial-muted leading-relaxed">
                  Bio Peptides operates from the UK and ships exclusively within the UK. All orders leave our UK fulfilment facility, which keeps lead times short and delivery reliable via tracked courier. We don&rsquo;t currently ship internationally. For bulk or institutional orders that need bespoke logistics, contact us before placing your order so we can talk through the options.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-editorial-muted leading-relaxed mb-6">
            Ready to order, or want to talk it through first? Contact the Bio Peptides team today — same-day dispatch on orders placed before 2pm.
          </p>
