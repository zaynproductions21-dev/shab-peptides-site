...
export const metadata: Metadata = {
  title: "Cookie Policy | Bell Peptides",
  description:
    "Cookie policy for Bell Peptides. How we use cookies and similar technologies on bellpeptides.co.uk, and how to manage your preferences.",
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="text-editorial-muted leading-relaxed space-y-8">
            ...
            <div>
              ...
              <p>Cookies are small text files stored on your device when you visit a website. They are widely used to make websites work efficiently, provide information to site owners, and improve the user experience. This policy explains what cookies Bell Peptides (bellpeptides.co.uk) uses and why.</p>
              <p className="mt-2">Bell Peptides is a trading name of <strong className="text-editorial-text">BELL RED LIMITED</strong> (Company Number 12841067), 16 Neptune Street, Tipton, England, DY4 8JF.</p>
            </div>
