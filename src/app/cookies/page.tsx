...
export const metadata: Metadata = {
  title: "Cookie Policy | Bio Peptides",
  description:
    "Cookie policy for Bio Peptides. How we use cookies and similar technologies on biopeptides.co.uk, and how to manage your preferences.",
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="text-editorial-muted leading-relaxed space-y-8">
            ...
            <div>
              ...
              <p>Cookies are small text files stored on your device when you visit a website. They are widely used to make websites work efficiently, provide information to site owners, and improve the user experience. This policy explains what cookies Bio Peptides (biopeptides.co.uk) uses and why.</p>
              <p className="mt-2">Bio Peptides is a trading name of <strong className="text-editorial-text">BELL RED LIMITED</strong> (Company Number 12841067), 16 Neptune Street, Tipton, England, DY4 8JF.</p>
            </div>
            ...
            <div>
              ...
              <p>For more information about cookies and how to manage them, visit <a href="https://www.allaboutcookies.org" className="text-editorial-accent hover:text-editorial-accent-dark transition-colors" target="_blank" rel="noopener noreferrer">allaboutcookies.org</a>. For questions about our use of cookies, contact us at <a href="mailto:research@biopeptides.co.uk" className="text-editorial-accent hover:text-editorial-accent-dark transition-colors">research@biopeptides.co.uk</a>.</p>
            </div>
