...
export const alt = 'Shab Peptides — Research Peptides UK'
    ...
    (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', background: 'linear-gradient(135deg, #1f2937, #111827)', fontFamily: 'Inter, system-ui, sans-serif' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 80, height: 80, borderRadius: 20, background: 'linear-gradient(135deg, #6366f1, #0891b2)', fontSize: 36, fontWeight: 800, color: '#fff' }}>SP</div>
          <div style={{ fontSize: 52, fontWeight: 800, color: '#ffffff', letterSpacing: -2 }}>Shab Peptides</div>
