...
export const metadata: Metadata = {
  title: "Press Releases | Bio Peptides UK",
  description:
    "Official press releases and company announcements from Bio Peptides — UK's research peptide supplier. Distribution-ready statements for journalists and partners.",
  alternates: { canonical: "/press" },
  openGraph: {
    title: "Press Releases | Bio Peptides UK",
    description: "Official press releases and company announcements from Bio Peptides.",
    url: "/press",
    type: "website",
  },
};
