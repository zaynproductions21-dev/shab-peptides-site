        ...
        <div className="mx-auto max-w-xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-6 rounded-lg bg-editorial-accent/5 border border-editorial-accent/15 p-3">
            <p className="text-[11px] text-editorial-accent leading-relaxed">
              All compounds are supplied strictly for in vitro research use only. Orders are subject to research verification. BELL RED LIMITED (trading as Bio Peptides), Company No. 12841067.
            </p>
          </div>
