    ...
    <>
      ...
      <section className="pt-24 pb-16 lg:pt-32 bg-editorial-surface min-h-[60vh]">
        <div className="mx-auto max-w-xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* Always-visible WhatsApp CTA — works for desktop customers whose
              auto-popup never sent, and gives anyone a fast way to reach us. */}
          <div className="mt-8 rounded-xl bg-[#25D366]/5 border-2 border-[#25D366]/30 p-5 text-left">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="font-serif text-base font-bold text-editorial-text leading-tight">
                  We&rsquo;ll WhatsApp you within 60 minutes
                </h2>
                <p className="mt-1 text-sm text-editorial-muted leading-relaxed">
                  If you&rsquo;d prefer to reach us first — or you ordered from a desktop and want to save us as a contact — tap below to message Premio on WhatsApp.
                </p>
                <a
                  href={WHATSAPP_ORDER_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-3 inline-flex items-center justify-center gap-2 rounded-lg bg-[#25D366] px-5 py-3 text-sm font-semibold text-white hover:bg-[#20BD5A] transition-colors w-full sm:w-auto"
                >
