...
export const metadata: Metadata = {
  title: "Privacy Policy | Bio Peptides",
  description:
    "Privacy policy for Bio Peptides, a trading name of BELL RED LIMITED. How we collect, use, and protect your personal data under UK GDPR.",
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="text-editorial-muted leading-relaxed space-y-8">
            ...
            <div>
              ...
              <p>Bio Peptides is a trading name of <strong className="text-editorial-text">BELL RED LIMITED</strong>, a company registered in England and Wales (Company Number 12841067). Our registered address is 16 Neptune Street, Tipton, England, DY4 8JF.</p>
              <p className="mt-2">For the purposes of the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018, BELL RED LIMITED is the data controller. If you have any questions about this policy or how we handle your data, contact us at <a href="mailto:research@biopeptides.co.uk" className="text-editorial-accent hover:text-editorial-accent-dark transition-colors">research@biopeptides.co.uk</a>.</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">To exercise any of these rights, contact us at <a href="mailto:research@biopeptides.co.uk" className="text-editorial-accent hover:text-editorial-accent-dark transition-colors">research@biopeptides.co.uk</a>. We will respond within one month. You also have the right to lodge a complaint with the Information Commissioner&rsquo;s Office (ICO) at <a href="https://ico.org.uk" className="text-editorial-accent hover:text-editorial-accent-dark transition-colors" target="_blank" rel="noopener noreferrer">ico.org.uk</a>.</p>
            </div>
