...
export const metadata: Metadata = {
  title: "Terms of Service | Bio Peptides",
  description:
    "Terms and conditions for purchasing research peptides from Bio Peptides, a trading name of BELL RED LIMITED. Research use only.",
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="text-editorial-muted leading-relaxed space-y-8">
            ...
            <div>
              ...
              <p>These terms of service (&ldquo;Terms&rdquo;) govern your use of the Bio Peptides website (biopeptides.co.uk) and any purchase of products from us. Bio Peptides is a trading name of <strong className="text-editorial-text">BELL RED LIMITED</strong>, registered in England and Wales (Company Number 12841067), with its registered address at 16 Neptune Street, Tipton, England, DY4 8JF.</p>
            ...
            <div>
              ...
              <p>All products sold by Bio Peptides are intended strictly for in vitro laboratory research, scientific study, and educational purposes only. They are <strong className="text-editorial-text">not</strong> intended for:</p>
            ...
            <div>
              ...
              <p>Due to the nature of research compounds and the requirement to maintain chain of custody, we cannot accept returns of opened or used products. If you receive a product that is damaged, incorrect, or does not match its certificate of analysis, contact us within 7 days of delivery at <a href="mailto:research@biopeptides.co.uk" className="text-editorial-accent">research@biopeptides.co.uk</a> with your order reference and a description of the issue. We will investigate and, where appropriate, offer a replacement or refund.</p>
            </div>

            <div>
              <h2 className="font-serif text-xl font-bold text-editorial-text mb-3">9. Limitation of Liability</h2>
              <p>Bio Peptides (BELL RED LIMITED) shall not be liable for any indirect, incidental, or consequential damages arising from the use or inability to use our products. Our total liability in respect of any order shall not exceed the value of that order. Products are supplied for research use only, and we accept no responsibility for use outside this scope.</p>
            </div>
            ...
            <div className="rounded-xl border border-editorial-border bg-editorial-surface p-6">
              ...
              <div className="space-y-1 text-sm">
                <p><strong className="text-editorial-text">BELL RED LIMITED</strong> (trading as Bio Peptides)</p>
                <p>16 Neptune Street, Tipton, England, DY4 8JF</p>
                <p>Company Number: 12841067</p>
                <p>Email: <a href="mailto:research@biopeptides.co.uk" className="text-editorial-accent">research@biopeptides.co.uk</a></p>
              </div>
            </div>
