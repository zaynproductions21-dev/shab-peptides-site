...
export const metadata: Metadata = {
  title: "UK Peptide Regulations | Legal Compliance | Bio Peptides",
  description:
    "Understand the legal framework around research peptides in the UK. Bio Peptides supplies third-party tested compounds for research use only.",
};
...
const faqs = [
  ...
  {
    question: "Does Bio Peptides have MHRA approval?",
    answer:
      "No. Bio Peptides does not hold MHRA approval, and our products are not licensed medicinal products. MHRA approval applies to medicines intended for human or veterinary use. Our compounds are supplied exclusively for research purposes and are not presented as medicines. We make no claims to the contrary.",
  },
  {
    question: "Who is permitted to buy research peptides from Bio Peptides?",
    answer:
  ...
  },
  {
    ...
    answer:
      "A certificate of analysis (CoA) is a document produced by an independent third-party laboratory confirming the identity and purity of a compound. Every Bio Peptides product ships with one. It allows researchers to verify exactly what they have received — a standard requirement in legitimate research settings and a basic condition for accurate record-keeping and reproducibility.",
  },
  {
    question: "Can I use Bio Peptides' compounds for clinical trials or on humans?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Consult your institution's legal, ethics, or compliance team before placing an order. Independent legal advice may also be appropriate. Bio Peptides cannot advise on the legal status of compounds for individual use cases, and nothing on this site constitutes legal guidance.",
  },
];
    ...
    <>
      ...
      <section className="py-16 lg:py-20 bg-editorial-surface">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-editorial-muted leading-relaxed space-y-4">
            <p>
              Under UK law, a substance becomes a medicinal product when it is presented as treating, preventing, or diagnosing a condition in humans or animals — or when it functions as one. Bio Peptides does not present any compound in this way. Our products are supplied as research chemicals for laboratory and academic use only. No therapeutic claims are made, and none of our compounds are MHRA-licensed medicines.
            </p>
            <p>
              Researchers should know that the MHRA can investigate suppliers where compounds are marketed or used in ways that imply medicinal intent. Bio Peptides operates with that line clearly in view.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-editorial-muted leading-relaxed space-y-4">
            <p>
              Every compound Bio Peptides sells is designated for in vitro research, laboratory analysis, and scientific study only. Not for human or veterinary consumption. Not for clinical use or self-administration. This classification carries legal and ethical weight — it is not a disclaimer inserted for form&rsquo;s sake.
            </p>
            <p>
      ...
      <section className="py-16 lg:py-20 bg-editorial-surface">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-editorial-muted leading-relaxed space-y-4">
            <p>
              Placing an order with Bio Peptides constitutes confirmation that the compounds will be used solely for lawful research purposes. Buyers are responsible for understanding the legal framework that applies to their institution, jurisdiction, and intended use.
            </p>
            <p>
              Researchers based at universities, private laboratories, or commercial R&amp;D operations should consult their institution&rsquo;s compliance or ethics team before ordering. Importation rules may apply if you are ordering from outside Great Britain. Bio Peptides does not provide legal advice. Nothing on this website should be read as guidance on the legality of any specific research application.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-editorial-muted leading-relaxed space-y-4">
            <p>
              Bio Peptides operates on a clear standard: stock held in the UK, dispatched from UK-based facilities, and a third-party certificate of analysis (CoA) supplied with every product. CoAs are produced by independent laboratories and confirm compound identity and purity.
            </p>
            <p>
