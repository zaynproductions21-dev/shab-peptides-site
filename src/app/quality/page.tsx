...
export const metadata: Metadata = {
  title: "Research Peptides Certificate of Analysis | Premio Peptides UK",
  description:
    "Every Premio Peptides compound ships with third-party HPLC and mass spectrometry data. UK-stocked, same-day dispatch by 2pm. Research use only.",
...
const faqs = [
  {
    question: "What does a certificate of analysis from Premio Peptides include?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. All analytical testing is commissioned from third-party laboratories that operate independently of Premio Peptides and have no commercial interest in the result. Our testing partners run ISO-accredited facilities and issue documentation under their own laboratory reference. We do not issue self-certified CoAs or rely solely on documentation provided by peptide manufacturers.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Every order dispatched by Premio Peptides includes a batch reference number on the accompanying documentation. That batch reference corresponds directly to the certificate of analysis for that specific lot. If you need to retrieve your CoA after dispatch, contact our support team with your order number and batch reference. We maintain archived analytical records for all batches supplied and can reissue documentation on request.",
  },
  {
    question: "Are Premio Peptides compounds suitable for use in human subjects?",
    answer:
    ...
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Quality & Testing", item: "https://premiopeptides.co.uk/quality" },
        ],
      }) }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg border border-editorial-border">
              <Image
                ...
                alt="HPLC and mass spectrometry equipment in Premio Peptides quality control laboratory"
                fill
      ...
      <section className="py-16 lg:py-20 bg-editorial-surface">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-editorial-muted leading-relaxed space-y-4">
            <p>
              Every compound dispatched by Premio Peptides carries a batch reference number linked directly to its certificate of analysis. That number appears on your order documentation. Any researcher can request the corresponding CoA at any point after purchase — traceability does not end at the point of dispatch.
            </p>
            <p>
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-editorial-muted leading-relaxed space-y-4">
            <p>
              A representative certificate of analysis is available to download below. It illustrates the format and content of the documentation that accompanies every Premio Peptides order: compound name and CAS number, batch reference, HPLC chromatogram, purity percentage, MS confirmation data, laboratory details, and date of analysis.
            </p>
            <p>
