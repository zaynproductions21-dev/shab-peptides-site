...
export const metadata: Metadata = {
  title: "About Premio Peptides | UK Research Peptide Supplier",
  description:
    "Premio Peptides is a trading name of BELL RED LIMITED. UK-based supplier of research-grade peptides with third-party testing, same-day dispatch, and dedicated institutional support.",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="text-editorial-muted leading-relaxed space-y-4">
                <p>
                  Premio Peptides is a UK-based supplier of research-grade peptides, serving universities, pharmaceutical companies, biotechnology firms, contract research organisations, and government laboratories. We operate under <strong className="text-editorial-text">BELL RED LIMITED</strong>, a company registered in England and Wales (Company Number 12841067).
                </p>
                <p>
            ...
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg border border-editorial-border">
              <Image
                ...
                alt="Premio Peptides laboratory facility"
                fill
          ...
          <div className="rounded-xl border border-editorial-border bg-white p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-semibold text-editorial-text">Premio Peptides</p>
              </div>
              <div>
